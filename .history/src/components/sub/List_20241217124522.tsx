...
import { getAllOperadora } from "@/functions/operadora";
...
const getList = async (type: ListProps['type']): Promise<Item[]> => {
    switch(type){
        case 'servicos': return await getAllServices();
        case 'paises': return await getAllCountry();
        case 'operadora': return await getAllOperadora(); // Implemente conforme necessário
