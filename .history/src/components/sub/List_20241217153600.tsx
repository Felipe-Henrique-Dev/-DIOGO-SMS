...
export const List: React.FC<ListProps> = ({ filter, favorites, setFavorites, setSelect, listLoading }) => {
    const list = listLoading === 'pais' ? use(getAllCountry()) : use(getAllServices()) as any;
