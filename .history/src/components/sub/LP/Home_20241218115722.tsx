...
export const Home = () => {
  return (
    <Section className=" text-black items-center py-20 flex-row" >
        <Image src="/mochups/header-img.png" width={300} height={300} alt="hero" />
        <div className="flex flex-col items-center">
            ...
            <p className="mt-8 text-base w-4/5">
