...
export const Home = () => {
  return (
    <Section className=" text-black items-center py-20 flex-row gap-5 relative justify-end" >
        <Image src="/mochups/header-img.png" width={700} height={700} alt="hero" className="absolute -left-14 " />
        <div className="flex flex-col items-center w-3/5 z-10 backdrop-blur-md relative">
            <span className="absolute top-0 left-0 right-0 bg-gradient-to-r h-full w-1/2 from-background_secondary to-transparent from-90% -z-10"></span>
