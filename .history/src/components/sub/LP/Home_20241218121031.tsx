  ...
  return (
    <Section className=" text-black items-center py-20 flex-row gap-5 relative justify-end" >
        ...
        <div className="flex flex-col items-center w-3/5 z-10 backdrop-blur-sm relative p-2 py-5 rounded-xl overflow-hidden">
            <span className="absolute top-0 left-0 right-0 bg-gradient-to-r h-full w-1/2 from-background to-transparent to-90% -z-10"></span>
            ...
            <Button className="mt-8" type={"button"} isLoading={false} size="lg" bgColor="primary">
                Comece Agora
            </Button>
        </div>
    </Section>
