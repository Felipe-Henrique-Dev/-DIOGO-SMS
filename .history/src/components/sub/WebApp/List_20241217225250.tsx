...
export const List = ({ filter, favorites, setFavorites, setSelect, type, service, filterSelect, setItems}: ListProps) => {
    ...
    const filteredAndSortedList = useMemo(() => {
        ...
        if (type === 'country') {
            ...
            setItems(uniqueCountries)
            return uniqueCountries
        }

    }, [list, type, serviços, filterSelect, setItems, filter, favorites]);
