...

            {
                type === 'service' && 
                    filteredAndSortedList.map((item: any, index:number) => (
                        <div className="w-full flex items-center justify-start gap-2 bg-background_secondary px-1 py-2 rounded-lg cursor-pointer " onClick={() => setSelect(item)} key={item.name+index}>
                            <Stars
                            ...
                            <span className="text-lg font-bold w-full text-start text-black ">{item.name}</span>
                        </div>
                    ))
            }

            {
                type === 'country' && 
                    filteredAndSortedList.map((item: any, index:number) => {
                        ...
                        return (
                            <div className="w-full flex items-center justify-start gap-2 bg-background_secondary px-1 py-2 rounded-lg cursor-pointer " onClick={() => setSelect(item)} key={item.country_name + index}>
                                <Stars
                                ...
                                <span className="text-lg font-bold w-full text-start text-black ">{item.country_name}</span>
