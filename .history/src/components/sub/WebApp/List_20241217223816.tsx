...
export const List = ({ filter, favorites, setFavorites, setSelect, type, service, filterSelect}: ListProps) => {
    ...
    const filteredAndSortedList = useMemo(() => {
        ...
        if (type === 'service') {
            ...
            if(filterSelect) {
                console.log('filteredAndSortedList filterSelect', filterSelect)
                uniqueServices = uniqueServices.filter((item: any) => {
                    console.log('filteredAndSortedList item', item)
                    return item.country_name === filterSelect.country_name
                })
            }
        ...
        if (type === 'country') {
            ...
            if(filterSelect) {
                uniqueCountries = list.filter((item: any) => item.country_name === filterSelect.country_name)
            }
