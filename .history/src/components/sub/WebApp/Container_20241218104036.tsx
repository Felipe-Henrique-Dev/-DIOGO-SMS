...
export const Container = ({
    ...
    if (type === 'operator' && operator) {
      return (
        <div className="flex flex-col gap-2 relative bg-black  ">
          <span className="bg-gradient-to-t from-black to-transparent w-full h-20 absolute top-0 left-0 rounded-t-lg" />
