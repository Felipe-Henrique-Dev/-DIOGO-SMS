        ...
        { 
          select ?
            <div className="flex w-full bg-light rounded-lg h-10 items-center justify-start px-5 gap-5 ">
              ...
              <Image src={`${baseUrl}${select.country_flag || select.logo }`} alt={select.country_name || select.logo} width={30} height={30}  className="rounded-full border-2 border-black min-w-8 h-8 " />
