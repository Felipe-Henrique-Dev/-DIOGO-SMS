...

            {
                type === 'service' && 
                    filteredAndSortedList.map((item: any, index:number) => (
                        <div className="w-full flex items-center justify-start gap-2 bg-secondary px-1 py-1 rounded-lg cursor-pointer " onClick={() => setSelect(item)} key={item.name+index}>
                            <Stars
...

            {
                type === 'country' && 
                    filteredAndSortedList.map((item: any, index:number) => {
                        ...
                        return (
                            <div className="w-full flex items-center justify-start gap-2 bg-secondary px-1 py-1 rounded-lg cursor-pointer " onClick={() => setSelect(item)} key={item.country_name + index}>
                                <Stars
