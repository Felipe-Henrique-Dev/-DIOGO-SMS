      ...
      <div className="flex flex-col gap-2 ">
        ...
        { 
          ...
          <>
            ...
            <div className="max-h-96 shadow-inner relative shadow-black py-4 w-full my-2 overflow-x-auto scroll-smooth rounded-lg px-2 text-black font-ubuntu flex flex-col gap-2 ">
