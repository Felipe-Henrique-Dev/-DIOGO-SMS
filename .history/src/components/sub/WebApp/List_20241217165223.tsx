...
export const List = ({ filter, favorites, setFavorites, setSelect, type, service, country }: ListProps) => {
    const countryList = use(country)
    const serviceList = use(service)
    const list = type === 'countries' ? countryList : serviceList as any

    console.log('loadingList', countryList)
