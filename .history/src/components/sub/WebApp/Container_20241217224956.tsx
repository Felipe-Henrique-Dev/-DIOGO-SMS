          ...
          <>
            ...
            <div className="max-h-96 shadow-inner shadow-black py-2 w-full my-2 overflow-x-auto scroll-smooth rounded-lg px-2 text-black font-ubuntu flex flex-col gap-2 ">
                <Suspense fallback={<SkeletonList />}>
                  <List type={type} filter={filter} favorites={favorites} setFavorites={setFavorites} setSelect={setSelect} service={service} filterSelect={filterSelect} setItems={setItems} />
                </Suspense>
                {/* {
                  type === 'operator' &&
