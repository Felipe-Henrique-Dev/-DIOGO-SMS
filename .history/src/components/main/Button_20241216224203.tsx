...
export const Button = ({
    ...
    const sizes = {
        sm: "w-1/2 h-8 text-base",
        md: "w-3/4 h-10 text-lg",
    ...
    return (
        <button 
            ...
            onClick={onClick}
            className={cn(
                "p-2 rounded-md relative shadow-sm shadow-black flex items-center justify-center font-bold font-ubuntu hover:scale-105 transition-transform duration-300",
                bgColors[bgColor],
                sizes[size],
                className
            )}
