...
export default function WebApp() {
  ...
  return (
    <aside className="min-w-[25rem] min-h-[90svh] shadow-sm shadow-black bg-background_secondary text-pri sticky left-0 top-[4.5rem] rounded-lg flex flex-col p-2 gap-5  pt-14 z-[999]">
    ...
    <div className="flex flex-col gap-2  ">
      ...
      { 
        ...
        <>
          ...
          <div className="h-96 bg-tertiary w-full my-2 overflow-x-auto scroll-smooth rounded-lg p-1 ">
