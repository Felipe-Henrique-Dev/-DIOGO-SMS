...
export const WebApp = ({services , countries}: {services: any , countries: any}) => {
  ...
  return (
    <aside className="min-w-[25rem] min-h-[90svh] shadow-lg shadow-black bg-background_secondary text-pri sticky left-0 top-[4.5rem] rounded-lg flex flex-col p-2 gap-5  pt-14 z-[999]">
      ...
      <Container subTitle="3. Selecione a operadora" select={selectOperator} setSelect={setSelectOperator} list={operatorFilter} operator={operatorFilter ? operatorFilter : 'none'} />
    </aside>
  );
}
