...
export const WebApp = ( { country, service }: { country: any, service: any }) => {
  ...
  return (
    <aside className="min-w-[25rem] min-h-[90svh] shadow-lg shadow-black  text-pri sticky backdrop-blur-sm left-0 top-[4.5rem] rounded-lg flex flex-col p-2 gap-5  pt-14 z-[999]">
