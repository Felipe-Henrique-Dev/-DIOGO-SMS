...
export const WebApp = () => {
  const services =  new Promise((r) => setTimeout(() => r('ok'), 10000))
  const countries =  new Promise((r) => setTimeout(() => r('ok'), 10000))
    ...
    <div className="flex flex-col gap-2  ">
      ...
      { 
        ...
        <>
          ...
          <div className="h-96 shadow-inner shadow-black py-2 w-full my-2 overflow-x-auto scroll-smooth rounded-lg p-1 text-black font-ubuntu flex gap-4 ">
            <Suspense fallback={<SkeletonList />}>
              <List listLoading={list} filter={filter} favorites={favorites} setFavorites={setFavorites} setSelect={setSelect} />
            </Suspense>
          </div>
        </>
      }
