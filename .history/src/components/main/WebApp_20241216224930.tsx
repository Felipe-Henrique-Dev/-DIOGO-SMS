...
const Container = ({
  ...
  return (
    <div className="flex flex-col gap-2  ">
      <span className="text-lg font-bold w-full text-start px-5 text-black font-ubuntu ">{subTitle}</span>
      { 
        select ?
        ...
        <>
          ...
          <div className="h-96 shadow-inner shadow-black py-2 w-full my-2 overflow-x-auto scroll-smooth rounded-lg p-1 text-black ">
