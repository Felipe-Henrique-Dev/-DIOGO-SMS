...
export const Button = ({
    ...
    return (
        <button 
            ...
            onClick={onClick}
            className={cn(
                "p-2 rounded-md relative shadow-md shadow-black flex items-center justify-center font-bold font-ubuntu hover:scale-105 transition-transform duration-300",
                bgColors[bgColor],
                sizes[size],
                className
            )}
