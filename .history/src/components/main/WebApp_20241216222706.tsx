...
export default function WebApp() {
  ...
  return (
    <aside className="min-w-[25rem] min-h-[90svh] bg-background_secondary text-pri sticky left-0 top-[4.5rem] rounded-lg flex flex-col p-2 gap-5  pt-14 z-[999]">
      <Image src="/logo.webp" alt="Logo" width={200} height={200} className="rounded-2xl absolute -top-16 transform -translate-x-1/2 left-1/2 z-[99] border-4 border-background " />
